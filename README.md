# 📄 Automação de Documentos com Excel e Word
...
- Leitura automática de dados a partir de planilhas Excel

- Preenchimento dinâmico de modelos Word
...
- Botão desativado durante o processamento para evitar múltiplas execuções
